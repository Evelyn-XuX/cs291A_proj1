...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #inject is kind of like iteration, and it store the status for every iteration
  end
  ...
  # The first one ensures that the file is closed after the block is executed, even if an error occurs during the execution of the block. 
  #
